    ...
    public void setObject() {
        ...
        switch (gp.mapIndex) {
            ...
            case (2):
                ...
                gp.obj[1] = new SuperObject("treesBg", 6 *gp.tileSize, 0 * gp.tileSize, true);
                gp.obj[1].displayWidth = gp.obj[1].image.getWidth() * 2;
                gp.obj[1].displayHeight = gp.obj[1].image.getHeight() * 2;

                //back row
                gp.obj[3] = new SuperObject("forestTree", 5 * gp.tileSize, 1.8 * gp.tileSize, true);
                gp.obj[3].displayWidth = gp.obj[3].image.getWidth() * 2;
                gp.obj[3].displayHeight = gp.obj[3].image.getHeight() * 2;

                gp.obj[4] = new SuperObject("forestTree",4.9 *gp.tileSize, 3.2 * gp.tileSize, true);
...
//                gp.obj[20].displayHeight = gp.obj[20].image.getHeight() * 2;
                ...
                //middle row
                gp.obj[21] = new SuperObject("forestTree",14.9 * gp.tileSize, 6.1 * gp.tileSize, true);
                gp.obj[21].displayWidth = gp.obj[21].image.getWidth() * 2;
                gp.obj[21].displayHeight = gp.obj[21].image.getHeight() * 2;

                gp.obj[22] = new SuperObject("forestTree",13.1 * gp.tileSize, 5.8 * gp.tileSize, true);
                gp.obj[22].displayWidth = gp.obj[22].image.getWidth() * 2;
                gp.obj[22].displayHeight = gp.obj[22].image.getHeight() * 2;

                gp.obj[23] = new SuperObject("forestTree",11 * gp.tileSize, 6.3 * gp.tileSize, true);
                gp.obj[23].displayWidth = gp.obj[23].image.getWidth() * 2;
                gp.obj[23].displayHeight = gp.obj[23].image.getHeight() * 2;

                gp.obj[24] = new SuperObject("forestTree",9.3 * gp.tileSize, 6 * gp.tileSize, true);
                gp.obj[24].displayWidth = gp.obj[24].image.getWidth() * 2;
                gp.obj[24].displayHeight = gp.obj[24].image.getHeight() * 2;

                gp.obj[25] = new SuperObject("forestTree",7.4 * gp.tileSize, 5.8 * gp.tileSize, true);
                gp.obj[25].displayWidth = gp.obj[25].image.getWidth() * 2;
                gp.obj[25].displayHeight = gp.obj[25].image.getHeight() * 2;

                gp.obj[26] = new SuperObject("forestTree",5.1 * gp.tileSize, 6.1 * gp.tileSize, true);
                gp.obj[26].displayWidth = gp.obj[26].image.getWidth() * 2;
                gp.obj[26].displayHeight = gp.obj[26].image.getHeight() * 2;

                //front row
                gp.obj[28] = new SuperObject("forestTree",15 * gp.tileSize, 7.3 * gp.tileSize, true);
                gp.obj[28].displayWidth = gp.obj[28].image.getWidth() * 2;
                gp.obj[28].displayHeight = gp.obj[28].image.getHeight() * 2;

                gp.obj[29] = new SuperObject("forestTree",13.2 * gp.tileSize, 6.9 * gp.tileSize, true);
                gp.obj[29].displayWidth = gp.obj[29].image.getWidth() * 2;
                gp.obj[29].displayHeight = gp.obj[29].image.getHeight() * 2;

                gp.obj[30] = new SuperObject("forestTree",11.3 * gp.tileSize, 7 * gp.tileSize, true);
                gp.obj[30].displayWidth = gp.obj[30].image.getWidth() * 2;
                gp.obj[30].displayHeight = gp.obj[30].image.getHeight() * 2;

                gp.obj[31] = new SuperObject("forestTree",9.4 * gp.tileSize, 7.35 * gp.tileSize, true);
                gp.obj[31].displayWidth = gp.obj[31].image.getWidth() * 2;
                gp.obj[31].displayHeight = gp.obj[31].image.getHeight() * 2;

                gp.obj[32] = new SuperObject("forestTree",7.6 * gp.tileSize, 7 * gp.tileSize, true);
                gp.obj[32].displayWidth = gp.obj[32].image.getWidth() * 2;
                gp.obj[32].displayHeight = gp.obj[32].image.getHeight() * 2;

                gp.obj[33] = new SuperObject("forestTree",5.7 * gp.tileSize, 6.8 * gp.tileSize, true);
                gp.obj[33].displayWidth = gp.obj[33].image.getWidth() * 2;
                gp.obj[33].displayHeight = gp.obj[33].image.getHeight() * 2;

                gp.obj[34] = new SuperObject("forestBush1", 1*gp.tileSize, 10 * gp.tileSize, true);

                gp.obj[35] = new SuperObject("forestBush1", 1.2*gp.tileSize, 9.4 * gp.tileSize, true);

                gp.obj[36] = new SuperObject("forestBush2", 5*gp.tileSize, 8.3 * gp.tileSize, true);

                gp.obj[37] = new SuperObject("forestBush1", 12.7*gp.tileSize, 9.2 * gp.tileSize, true);

                gp.obj[38] = new SuperObject("stoutstill", 1.8*gp.tileSize, 3.3 * gp.tileSize, true);

                gp.obj[39] = new SuperObject("forestBush1", 2*gp.tileSize, 3.8 * gp.tileSize, true);

                gp.obj[49] = new SuperObject("forestBush2", 2*gp.tileSize, 2.8 * gp.tileSize, true);

                gp.obj[50] = new SuperObject("forestBush2", 13.3*gp.tileSize, 9.8 * gp.tileSize, true);

                gp.obj[51] = new SuperObject("forestBush2", 6.6*gp.tileSize, 9.3 * gp.tileSize, true);

                gp.obj[52] = new SuperObject("pinkPlants", 1*gp.tileSize, 5 * gp.tileSize, true);

                gp.obj[54] = new SuperObject("forestTree",0 * gp.tileSize, 1 * gp.tileSize, true);
                gp.obj[54].displayWidth = gp.obj[54].image.getWidth() * 2;
                gp.obj[54].displayHeight = gp.obj[54].image.getHeight() * 2;

                gp.obj[55] = new SuperObject("forestTree",0.3 * gp.tileSize, 3 * gp.tileSize, true);
                gp.obj[55].displayWidth = gp.obj[55].image.getWidth() * 2;
                gp.obj[55].displayHeight = gp.obj[55].image.getHeight() * 2;

                gp.obj[56] = new SuperObject("forestTree",0.2 * gp.tileSize, 5 * gp.tileSize, true);
                gp.obj[56].displayWidth = gp.obj[56].image.getWidth() * 2;
                gp.obj[56].displayHeight = gp.obj[56].image.getHeight() * 2;

                gp.obj[57] = new SuperObject("forestTree",0.4 * gp.tileSize, 6 * gp.tileSize, true);
                gp.obj[57].displayWidth = gp.obj[57].image.getWidth() * 2;
                gp.obj[57].displayHeight = gp.obj[57].image.getHeight() * 2;

                gp.obj[58] = new SuperObject("forestTree",0.1 * gp.tileSize, 8 * gp.tileSize, true);
                gp.obj[58].displayWidth = gp.obj[58].image.getWidth() * 2;
                gp.obj[58].displayHeight = gp.obj[58].image.getHeight() * 2;

                gp.obj[59] = new SuperObject("forestTree",0 * gp.tileSize, 10 * gp.tileSize, true);
                gp.obj[59].displayWidth = gp.obj[59].image.getWidth() * 2;
                gp.obj[59].displayHeight = gp.obj[59].image.getHeight() * 2;

                gp.obj[60] = new SuperObject("forestBorder", 1 * gp.tileSize, 12 * gp.tileSize, true);
